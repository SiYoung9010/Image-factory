...
export const IsolateIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const ObjectDetectIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M3 8.25V15.75a2.25 2.25 0 002.25 2.25h7.5a2.25 2.25 0 002.25-2.25V8.25a2.25 2.25 0 00-2.25-2.25h-7.5A2.25 2.25 0 003 8.25z" />
...
export const WandIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.998 15.998 0 011.622-3.385m5.043.025a15.998 15.998 0 001.622-3.385m3.386 5.043a15.998 15.998 0 00-1.622-3.385m0 0a15.998 15.998 0 013.388-1.62m-5.043-.025a15.998 15.998 0 01-1.622-3.385m-3.386 5.043a15.998 15.998 0 01-1.622-3.385m0 0a15.998 15.998 0 00-3.388-1.62m5.043.025a15.998 15.998 0 00-1.622-3.385m-5.043-.025a15.998 15.998 0 01-1.622-3.385m0 0a15.998 15.998 0 00-3.386-1.622m0 0a15.998 15.998 0 01-3.386-1.622m0 0a15.998 15.998 0 00-1.622-3.385m3.386 5.043a15.998 15.998 0 00-1.622-3.385" />
    </svg>
);
...
export const TextScanIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 21l5.25-11.25L21 21m-9-3h7.5M3 5.621a48.474 48.474 0 016-.371m0 0c1.12 0 2.233.038 3.334.114M9 5.25V3m3.334 2.364C13.18 7.061 14.289 7.5 15.5 7.5c1.21 0 2.32-.439 3.166-1.136m0 0V3m-3.166 1.136c.621.493 1.282.875 1.992 1.124M3 21h18M3 11.25h18" />
